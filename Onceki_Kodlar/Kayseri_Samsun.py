...
class_colors = {
    'Samsunspor': (0, 255, 0),         # Yeşil (takım A)
    'Kayserispor': (0, 140, 255),     # Turuncu-Sarı (takım B)
...
print(ortalama_samsunspor)
if ortalama_kayserispor[1] < ortalama_samsunspor[1]:
    team_a_color = ortalama_kayserispor
else:
    team_b_color = ortalama_samsunspor
